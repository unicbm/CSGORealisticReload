...
- 新回合开始或玩家出生时会丢弃上一回合未完成的换弹跟踪，避免影响新回合备弹恢复。
...
- Drops unfinished reload tracking on round start and player spawn so new-round reserve ammo restoration is preserved.
